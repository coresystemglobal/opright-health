import { Ambulance, AmbulanceStatus } from '@modules/ambulance/ambulance.model';

import { AmbulanceRequest, RequestStatus, EmergencyLevel } from '@modules/ambulance/ambulance-request.model';
